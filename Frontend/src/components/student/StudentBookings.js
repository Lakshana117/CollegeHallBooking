...
function StudentBookings() {
    ...
    // Process data for the bar chart (Booking count per month, including past and future bookings)
    ...
    const deleteBooking = async (id) => {
        try {
            ...
            if (response.ok) {
                fetchBookings();  // Refresh bookings after successful delete
            } else {
    ...
    return (
        <div className="student-bookings-container">
            <h2 className="student-h2">User Bookings Overview</h2>

            {/* Table Section */}
            <div className="student-bookings-table-container">
                            ...
                            <tr key={booking.id}>
                                ...
                                <td>
                                    <button
                                        ...
                                        onClick={() => deleteBooking(booking.id)}  // Pass the booking id
                                    >
                                        Delete
                                    </button>
                                </td>
            ...
            {/* Bar Chart Section */}
            <div className="student-bar-chart-container">
                <h3 className="student-h3">Bookings Count by Month</h3>
                <BarChart
                    width={800}
                    height={300}
